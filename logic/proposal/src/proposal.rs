...
pub struct Proposal {
    ...
    pub cost: U256, // pub participants: BTreeMap<AccountHash, Participant>,
}
...
impl Proposal {
    pub fn new(
        ...
        let reputation_quorum: u64 = vote_configuration.0 .1;
        let threshold: u8 = vote_configuration.1 .0;
        let timeout: u8 = vote_configuration.1 .1;
